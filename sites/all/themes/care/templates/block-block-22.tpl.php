...
<div class='btn_todo next'><?php echo l('Start Next Principle', 'dashboard/principle-4');?></div>
<div class='btn_download'><?php echo l('Download & Print Lesson Three', 'printpdf/141445');?></div>
    <div class="clear"></div>
  </div>
</div>
