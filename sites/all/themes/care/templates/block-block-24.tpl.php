...
<div class='btn_todo next'><?php echo l('Start Next Principle', 'dashboard/principle-6');?></div>
<div class='btn_download'><?php echo l('Download & Print Lesson Five', 'printpdf/141447');?></div>
    <div class="clear"></div>
  </div>
</div>
