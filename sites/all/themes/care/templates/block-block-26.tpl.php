...
<div class='btn_todo next'><?php echo l('Start Next Principle', 'dashboard/principle-8');?></div>
<div class='btn_download'><?php echo l('Download & Print Lesson Seven', 'printpdf/141449');?></div>
    <div class="clear"></div>
  </div>
</div>
