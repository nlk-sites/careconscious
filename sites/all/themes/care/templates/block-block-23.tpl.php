...
<div class='btn_todo next'><?php echo l('Start Next Principle', 'dashboard/principle-5');?></div>
<div class='btn_download'><?php echo l('Download & Print Lesson Four', 'printpdf/141446');?></div>
    <div class="clear"></div>
  </div>
</div>
